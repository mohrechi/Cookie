...
const int MAXL = 22;
const int KIND = 9;
const int MAXNODE = 42;

vector<int> A, B, RA, RB;
char subA[MAXL], subB[MAXL];
int n, end[MAXNODE], suffix[MAXNODE];
int q[MAXNODE], child[MAXNODE][KIND];
__int64 dp[MAXL][3][3][3][3][MAXNODE][1 << 2];
